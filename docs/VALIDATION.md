...
|---|---|---|
| Standalone impulse calculation | zero-impulse and prograde-impulse limiting cases | PASS for declared software tests |
| Host recoil | linear-momentum conservation identity | PASS for declared software test |
